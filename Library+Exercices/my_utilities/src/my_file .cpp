...
void myFile::Test()
{
        myFile::save("test_my_utilities_file.test","Test 1 : writing into a file.");
        myFile::save("test_my_utilities_file.test",3000, true);
        myFile::save("test_my_utilities_file.test",0xa, true);
        ...
        myFile::save("test_my_utilities_file.txt",
                ...
                \n     Test 1.1 : writing into a file with number.\
                \n     Test 1.2 : writing into a file with hex number.\
